...
import { contentStyle, ctaButton, heroBackground, heroStyle, heroSubtitle, heroTextStyles, heroTitle, imageContainer, leftContainer, overlayStyle, rightContainer } from './Hero.styles';
    ...
    <Box sx={heroBackground}>
      ...
      <Box sx={{ ...heroStyle, ...contentStyle }}>
        <Box sx={leftContainer}>
          <Typography variant='h1' sx={heroTitle}>See All Sides of Every Story</Typography>
          <AnimatedWordList />
          <Typography sx={heroSubtitle}>Because Somewhere, Something Incredible is Waiting to be Known.</Typography>
        ...
        <Box sx={rightContainer}>
          <Box sx={imageContainer} >
            <img style={{ width: '100%'}} src="images/hero/side-hero-images.png" alt="info images" />
          </Box>
        </Box>
      </Box>
    </Box>
